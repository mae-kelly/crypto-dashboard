      ...
      <div className="space-y-6 sm:space-y-8">
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">PATTERNS</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">{lensMetrics.activePatterns}</div>
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">ACCURACY</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">{lensMetrics.predictionAccuracy.toFixed(1)}%</div>
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">PROFITS</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">+${lensMetrics.todaysProfits.toFixed(0)}</div>
              <div className="text-[10px] sm:text-xs text-neutral-400">today</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">ALERTS</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">{lensMetrics.alertsTriggered}</div>
              <div className="text-[10px] sm:text-xs text-neutral-400">triggered</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">TRACKING</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">
                {(lensMetrics.correlationsTracked / 1000).toFixed(1)}K
              </div>
              <div className="text-[10px] sm:text-xs text-neutral-400">correlations</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">SUCCESS</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">{lensMetrics.successRate.toFixed(1)}%</div>
              <div className="text-[10px] sm:text-xs text-neutral-400">win rate</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-neutral-950 border-neutral-800 hover:border-neutral-700 transition-colors col-span-2 sm:col-span-1">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-[10px] sm:text-xs text-neutral-500 font-mono">DATA/HR</div>
              </div>
              <div className="text-xl sm:text-2xl font-extralight text-white">2.4M</div>
              <div className="text-[10px] sm:text-xs text-neutral-400">processed</div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <CardContent className="p-0">
              <div className="space-y-0">
                {alerts.map((alert, index) => (
                  <div
                    key={alert.id}
                    className={`p-4 sm:p-6 border-b border-neutral-900 border-l-2 ${getAlertBorder(alert.status)} ${index === alerts.length - 1 ? "border-b-0" : ""}`}
                  >
          ...
          <Card className="bg-neutral-950 border-neutral-800">
            <CardHeader className="border-b border-neutral-900">
              <CardTitle className="text-white font-light flex items-center text-sm sm:text-base">
                <Brain className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-neutral-400" />
                Pattern Discovery
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <div className="space-y-0">
                {patterns.map((pattern, index) => (
                  <div
                    key={index}
                    className={`p-4 sm:p-6 border-b border-neutral-900 ${index === patterns.length - 1 ? "border-b-0" : ""}`}
                  >
                    ...
                    <div className="mt-4">
                      <Button
                        variant="outline"
                        className="w-full border-neutral-700 text-neutral-300 hover:bg-neutral-900 font-light text-xs bg-transparent"
                      >
                        MONITOR PATTERN
                      </Button>
                    </div>
        ...
        <Card className="bg-neutral-950 border-neutral-800">
          <CardHeader className="border-b border-neutral-900">
            <CardTitle className="text-white font-light text-sm sm:text-base">LENS Neural Network Status</CardTitle>
          </CardHeader>
          <CardContent className="p-4 sm:p-6">
            <div className="bg-black p-4 sm:p-6 rounded border border-neutral-900 font-mono text-xs sm:text-sm space-y-4">
              <div className="text-white font-light text-xs sm:text-sm">LENS NEURAL NETWORK — OPERATIONAL STATUS</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-[10px] sm:text-xs">
                <div>
                  <div className="text-neutral-400 mb-2 sm:mb-3 font-mono">PATTERN RECOGNITION</div>
                  <div className="text-neutral-300 space-y-1 sm:space-y-2">
                    <div>• Neural pathways: 15,420</div>
                    <div>• Accuracy: {lensMetrics.predictionAccuracy.toFixed(1)}%</div>
                    <div>• Connections: 2,847</div>
                    <div>• Learning: Adaptive</div>
                  </div>
                </div>
                <div>
                  <div className="text-neutral-400 mb-2 sm:mb-3 font-mono">DATA PROCESSING</div>
                  <div className="text-neutral-300 space-y-1 sm:space-y-2">
                    <div>• Feeds: 247 active</div>
                    <div>• Latency: 12ms avg</div>
                    <div>• Quality: 98.3%</div>
                    <div>• Storage: 67%</div>
                  </div>
                </div>
                <div>
                  <div className="text-neutral-400 mb-2 sm:mb-3 font-mono">ALPHA GENERATION</div>
                  <div className="text-neutral-300 space-y-1 sm:space-y-2">
                    <div>• Signals: {lensMetrics.alertsTriggered} today</div>
                    <div>• Success: {lensMetrics.successRate.toFixed(1)}%</div>
                    <div>• Profit: +${lensMetrics.todaysProfits.toFixed(0)}</div>
                    <div>• Correlations: {(lensMetrics.correlationsTracked / 1000).toFixed(1)}K</div>
                  </div>
                </div>
                <div>
                  <div className="text-neutral-400 mb-2 sm:mb-3 font-mono">SYSTEM HEALTH</div>
                  <div className="text-neutral-300 space-y-1 sm:space-y-2">
                    <div>• CPU: 67%</div>
                    <div>• Memory: 78%</div>
              ...
              <div className="border-t border-neutral-800 pt-4">
                <div className="text-white text-xs sm:text-sm">ALL SYSTEMS OPERATIONAL</div>
